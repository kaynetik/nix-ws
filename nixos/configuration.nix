...

{
  ...
  networking.hostId = "5cadf6fe"; # Required for ZFS; head -c 8 /etc/machine-id
  ...
  ## Default remnants - keeping for mainenance purposes & as a hard reminder.
